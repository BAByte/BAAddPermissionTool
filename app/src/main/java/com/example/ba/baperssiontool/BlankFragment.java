...
public class BlankFragment extends Fragment {
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        Log.d("ssss", "onRequestPermissionsResult: ");
        AddPermission.callBack(requestCode, permissions, grantResults, new PermissionCallBack() {
            @Override
            public void onSuccess() {
                Toast.makeText(getActivity(), "请求权限成功", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFail(String[] permissions) {
                Toast.makeText(getActivity(), "权限请求失败,部分功能将无法使用", Toast.LENGTH_SHORT).show();
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d("ssssss", "sssssssss" + requestCode);
    }
}
